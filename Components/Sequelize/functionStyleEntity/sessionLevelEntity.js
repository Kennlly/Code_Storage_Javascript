   ...
   try {
      return SequelizeConfig.define("Gen_ConDetails_Session_STG", {
         ...
         address_to: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("address_to", value && value.substring(0, 255));
            },
         },
         address_self: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("address_self", value && value.substring(0, 255));
            },
         },
         address_other: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("address_other", value && value.substring(0, 255));
            },
         },
         journey_action_id: {
            type: DataTypes.STRING(36),
         ...
         journey_customer_id: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("journey_customer_id", value && value.substring(0, 255));
            },
         },
         journey_customer_id_type: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("journey_customer_id_type", value && value.substring(0, 255));
            },
         },
         journey_customer_session_id: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("journey_customer_session_id", value && value.substring(0, 255));
            },
         },
         journey_customer_session_id_type: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("journey_customer_session_id_type", value && value.substring(0, 255));
            },
         },
         sharing_screen: {
            type: DataTypes.BOOLEAN,
         ...
         screen_share_room_id: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("screen_share_room_id", value && value.substring(0, 255));
            },
         },
         screen_share_address_self: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("screen_share_address_self", value && value.substring(0, 255));
            },
         },
         flow_in_type: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("flow_in_type", value && value.substring(0, 255));
            },
         },
         flow_out_type: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("flow_out_type", value && value.substring(0, 255));
            },
         },
         cobrowse_role: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("cobrowse_role", value && value.substring(0, 255));
            },
         },
         cobrowse_room_id: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("cobrowse_room_id", value && value.substring(0, 255));
            },
         },
         disposition_analyzer: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("disposition_analyzer", value && value.substring(0, 255));
            },
         },
         disposition_name: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("disposition_name", value && value.substring(0, 255));
            },
         },
         video_room_id: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("video_room_id", value && value.substring(0, 255));
            },
         },
         video_address_self: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("video_address_self", value && value.substring(0, 255));
            },
         },
         skip_enabled: {
            type: DataTypes.BOOLEAN,
         ...
         media_bridge_id: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("media_bridge_id", value && value.substring(0, 255));
            },
         },
         media_count: {
            type: DataTypes.INTEGER,
         ...
         message_type: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("message_type", value && value.substring(0, 255));
            },
         },
         timeout_seconds: {
            type: DataTypes.INTEGER,
         ...
         protocol_call_id: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("protocol_call_id", value && value.substring(0, 255));
            },
         },
         authenticated: {
            type: DataTypes.BOOLEAN,
      ...
      type: DataTypes.STRING,
      set(value) {
         this.setDataValue("room_id", value && value.substring(0, 255));
      }
   },
         agent_assistant_id: {
            type: DataTypes.STRING(36),
   ...
   try {
      return SequelizeConfig.define("Gen_ConDetails_Callback_Numbers_STG", {
         ...
         callback_user_name: {
            type: DataTypes.STRING,
            set(value) {
               this.setDataValue("callback_user_name", value && value.substring(0, 255)value && value.substring(0, 255));
            },
         },
         stage_time: {
            type: DataTypes.DATE(0),
